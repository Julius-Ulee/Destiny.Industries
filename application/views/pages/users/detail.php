<div class="container mt-3">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-sm-12 my-2">
            <img src="<?=$content->image ? base_url("images/product/$content->image") : base_url("images/product/default.jpg") ?>" alt="" class="img-fluid" style="border-radius: 20px;">
        </div>
        <div class="col-lg-8 col-sm-12">
            <h4 class="title-product"><?= $content->product_title ?></h4>
            <h5 class="price-product">IDR <?= number_format($content->price, 0, ',', '.') ?></h5>
            <h5 class="price-product mt-3">Stock : <?= $content->stok ?></h5>
            <div class="mt-3">
    ...
    <div class="card shadow-lg mt-3" style="border-radius: 20px; background-color: #EDEADE;">
        <div class="card-body">
