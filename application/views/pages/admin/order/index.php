<div class="card shadow my-3">
    ...
    <div class="card-body">
        <div class="row my-2">
            ...
            <a href="<?= base_url('admin/order/print-report'); ?>" target="_blank" class="btn btn-sm btn-secondary"><i class="fa fa-print"> Print</i> </a>
            <a href="<?= base_url('admin/order/generate-pdf'); ?>" target="_blank" class="btn btn-sm btn-warning"><i class="far fa-file-pdf"> Download Pdf</i> </a>
            <a href="<?= base_url('admin/order/export_excel'); ?>" target="_blank" class="btn btn-sm btn-success"><i class="far fa-file-excel"> Export Excel</i> </a>  
            </div>
