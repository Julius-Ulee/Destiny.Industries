<div class="container my-4">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-9 col-sm-12">
            <div class="card mb-3" style="border-radius: 20px; background-color: #EDEADE;">
                <div class="card-header bg-secondary text-white" style="border-radius: 20px; background-color: #EDEADE;">
