...
class Shop extends MY_Controller 
{
    ...
    public function detail($slug)
    {
        ...
        $data['content']    = $this->shop->select(
            ['product.id', 'product.title AS product_title', 'product.description', 'product.size', 'product.color', 'product.price', 'product.is_available', 'product.image', 'category.title AS category_title', 'product.stok']
        )
        ->join('category')
