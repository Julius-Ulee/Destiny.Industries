       ...
       <div class="row">
           <div class="col-lg-6 col-md-6 col-sm-12">
               <a href="<?= base_url('shop/men') ?>">
                   <div class="single_promo" style="border-radius: 20px;">
           ...
           <div class="row text-center mt-3 mb-4">
                ...
                <div class="col-6 col-lg-3 col-sm-6">
                    <figure class="figure">
                        <div class="figure-img">
                            <img src="<?=$rowL->image ? base_url("images/product/$rowL->image") : base_url("images/product/default.jpg") ?>" class="figure-img img-fluid" alt="" style="border-radius: 20px;">
                            <a href="<?= base_url("shop/detail/$rowL->slug") ?>" class="d-flex justify-content-center" style="border-radius: 20px;">
            ...
            <div class="row text-center mt-3 mb-4">
                ...
                <div class="col-6 col-lg-3 col-sm-6">
                    <figure class="figure">
                        <div class="figure-img">
                            <img src="<?=$rowW->image ? base_url("images/product/$rowW->image") : base_url("images/product/default.jpg") ?>" class="figure-img img-fluid" alt="" style="border-radius: 20px;">
                            <a href="<?= base_url("shop/detail/$rowW->slug") ?>" class="d-flex justify-content-center" style="border-radius: 20px;">
                                <img src="<?= base_url() ?>assets/img/detail.png" alt="" class="align-self-center">
                            </a>
                        </div>
                        <figcaption class="figure-caption">
